  ...
  S.list()
    ...
    .items([
                  ...
                  S.documentTypeList('profile_type')
                    ...
                    .child((role) =>
                      S.documentList()
                        .defaultOrdering([{field: 'order', direction: 'asc'}])
                        .title('Profiles')
                        .filter('_type == "profile" && $role == role._ref && alumni == false')
                        .params({role})
                    )
                ),
              S.listItem()
                  ...
                  S.documentTypeList('profile_type')
                    ...
                    .child((role) =>
                      S.documentList()
                        .defaultOrdering([{field: 'order', direction: 'asc'}])
                        .title('Profiles')
                        .filter('_type == "profile" && $role == role._ref && alumni == true')
                        .params({role})
                    )
                ),
            ])
      ...
      ...S.documentTypeListItems().filter(
        (listItem) =>
          !['feature', 'card', 'research_doc', 'profile', 'profile_type'].includes(listItem.getId())
      ),
    ])
